    ...
    <div className="min-h-screen py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-7xl mx-auto mt-[12vh] ">
        ...
        <div className="w-[80%] lg:w-[50%] flex flex-col gap-4 justify-self-center">
          ...
          <button
            className="group/btn relative cursor-pointer block h-10 w-full rounded-md bg-white dark:bg-none dark:bg-gradient-to-br from-black to-neutral-600 font-medium dark:text-white text-black shadow-[0px_1px_0px_0px_#ffffff40_inset,0px_-1px_0px_0px_#ffffff40_inset] dark:bg-zinc-800 dark:from-zinc-900 dark:to-zinc-900 dark:shadow-[0px_1px_0px_0px_#27272a_inset,0px_-1px_0px_0px_#27272a_inset]"
            type="submit"
          >
            Enviar
            <BottomGradient />
